...
window.Spark = (function () {
  ...
  const commands = {
    ...
    // `savePreset` (0x0127) è stato tolto: sullo Spark 2 riceve l'ack e non
    // salva, in tutte e quattro le forme provate. Per scrivere in uno slot si
    // indirizza lo slot direttamente con 0x0101 — vedi `storePreset` nel
    // trasporto e la sezione sulla scrittura in CLAUDE.md.
